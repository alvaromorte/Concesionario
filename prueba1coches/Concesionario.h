...
public:
	...
	/*! \brief Vende un nuevo coche del inventario al usuario y lo añade a su lista de coches
	 * Tras ejecutar esta función se quita el coche del inventario
	 * @returns false si el coche no está en el inventario o en el clienta no puede pagarlo*/
	...
	* @returns false si el coche no está en taller y en estado de listo*/
